...
import { createBusiness, fetchCategories } from '../../services/api';
          ...
          <div className="bg-white rounded-lg p-6 border border-surface-3 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input {...register('tagline')} className="w-full mt-1 px-3 py-2.5 text-sm font-dm bg-surface-2 border border-surface-3 rounded focus:outline-none focus:border-brand-orange/50" placeholder="One-liner about your business" />
              </div>
              <div>
          ...
          <div className="bg-white rounded-lg p-6 border border-surface-3 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input {...register('city', { required: true })} className="w-full mt-1 px-3 py-2.5 text-sm font-dm bg-surface-2 border border-surface-3 rounded focus:outline-none focus:border-brand-orange/50" />
              </div>
              <div>
          ...
          <div className="bg-white rounded-lg p-6 border border-surface-3 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input {...register('lat')} className="w-full mt-1 px-3 py-2.5 text-sm font-dm bg-surface-2 border border-surface-3 rounded focus:outline-none focus:border-brand-orange/50" placeholder="17.449" />
              </div>
              <div>
                <label className="text-xs font-mono text-brand-muted uppercase tracking-wider">Longitude</label>
                <input {...register('lng')} className="w-full mt-1 px-3 py-2.5 text-sm font-dm bg-surface-2 border border-surface-3 rounded focus:outline-none focus:border-brand-orange/50" placeholder="78.391" />
              </div>
            </div>
          </div>
